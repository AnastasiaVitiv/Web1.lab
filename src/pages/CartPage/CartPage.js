...
function CartPage() {
    ...
    useEffect(() => {
        ...
        if (email) {
            const userCart = getCartForUser(email);
    ...
    useEffect(() => {
        ...
        if (email && cartItems.length >= 0) {
            ...
            if (registeredUsers[email]) {
                registeredUsers[email].cart = cartItems;
    ...
    const handleRemove = (shipId, selectedType) => {
        ...
        if (email) {
            removeFromUserCart(email, shipId, selectedType);
        }
    ...
    const handleQuantityChange = (shipId, selectedType, newQuantity, maxQuantity) => {
        ...
        if (email) {
            updateQuantityInUserCart(email, shipId, selectedType, newQuantity);
        }
